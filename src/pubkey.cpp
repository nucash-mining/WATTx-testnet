 ...
 */
// NUMS_H initialization - use constexpr where supported, otherwise runtime init
...
#else
const XOnlyPubKey XOnlyPubKey::NUMS_H{
    XOnlyPubKey{"50929b74c1a04954b78b4b6035e97a5e078a5a0f28ec96d547bfee9ace803ac0"_hex_u8}
};
#endif
