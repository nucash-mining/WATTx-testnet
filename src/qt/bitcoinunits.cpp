...
{
    switch (unit) {
    case Unit::BTC: return QString("WATTX");
    case Unit::mBTC: return QString("mWATTX");
    case Unit::uBTC: return QString::fromUtf8("µWATTX (bits)");
...
QString BitcoinUnits::description(Unit unit)
{
    switch (unit) {
    case Unit::BTC: return QString("WATTx");
    case Unit::mBTC: return QString("Milli-WATTx (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-WATTx (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
