...
contract InitDEX {
    ...
    function init(address _t0, address _t1) external {
    ...
    function removeLiq(uint256 lpAmt) external returns (uint256 a0, uint256 a1) {
        require(lp[msg.sender] >= lpAmt, "low");
        a0 = (lpAmt * reserve0) / totalLP;
        a1 = (lpAmt * reserve1) / totalLP;
        ...
        require(IERC20(token0).transfer(msg.sender, a0), "t0");
        require(IERC20(token1).transfer(msg.sender, a1), "t1");
    }
